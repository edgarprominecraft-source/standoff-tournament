  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.92 }}
        onClick={togglePlay}
        className="audio-btn fixed bottom-24 right-4 z-[5] w-11 h-11 rounded-full flex items-center justify-center shadow-lg"
        style={{
      ...
      <motion.button
        ...
        className="audio-btn fixed bottom-24 right-[68px] z-[5] w-11 h-11 rounded-full flex items-center justify-center shadow-lg"
        style={{
